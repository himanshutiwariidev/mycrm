      ...
      {open && (
        <div style={{
            ...
            return (
              <button
                ...
                style={{
                  ...
                  background: active ? "#fff4e6" : "transparent", color: active ? "#f7931e" : "#334155",
          ...
          <div style={{ borderTop: "1px solid #f0f1f6", marginTop: 8, paddingTop: 12 }}>
            ...
            <button
              ...
              style={{
                ...
                background: "#f7931e", color: "#fff", fontWeight: 700, fontSize: 12.5, cursor: "pointer", fontFamily: "inherit",
              }}
            >
              Apply Range
            </button>
          ...
          {presetLabel === "Custom Range" && (
            <div style={{ fontSize: 11, color: "#f7931e", fontWeight: 600, padding: "10px 6px 0" }}>Custom range active</div>
          )}
        </div>
      )}
    </div>

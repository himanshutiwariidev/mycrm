...
function buildDisciplineLeaves() {
  return [
    {
      id: "seo",
      label: "SEO",
    ...
    },
    {
      ...
      label: "AEO",
      fields: [
        { name: "targetKeywords", type: FIELD_TYPES.TAGS, label: "Target Keywords" },
      ...
      commonFields: true,
      pricing: { basis: "flat", defaultUnitPrice: 10000 },
    },
    {
      id: "geo",
      label: "GEO",
    ...
    },
    {
      ...
      commonFields: true,
      pricing: { basis: "flat", defaultUnitPrice: 8000 },
    },
  ];
}
...
export const rankingOptimizationConfig = {
  ...
  kind: "tab-tree",
  groups: [
    { id: "domestic", label: "Domestic", kind: "leaf-group", items: buildDisciplineLeaves() },
    { id: "international", label: "International", kind: "leaf-group", items: buildDisciplineLeaves() },
  ],
};

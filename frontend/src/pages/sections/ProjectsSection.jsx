...
import {
  ChartCard, CustomTooltip, IconBtn, kpiGridStyle, KpiCard, PROJECT_TAB_FIELDS, PROJECT_TABS, PROJECT_TYPES, PROJECT_STATUS, T, fmtShortDate,
} from "./shared";
    ...
    <div className="fade-up">
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 20 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap", justifyContent: "flex-end" }}>
          <button className="pri-btn" onClick={openCreateProject} style={{ display: "flex", alignItems: "center", gap: 7, padding: "9px 18px", background: "linear-gradient(135deg, #f7931e, #e8590c)", color: "#fff", borderRadius: 10, fontSize: 13, fontWeight: 600 }}>
                    ...
                    {tableFields.map(field => (
                      ...
                      <td style={{ padding: "13px 14px", whiteSpace: "nowrap" }}>
                        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                          <IconBtn icon={Pencil} color="#f7931e" bg="#fff4e6" hoverBg="#fed7aa" onClick={() => openEditProject(project)} title="Update project" />
